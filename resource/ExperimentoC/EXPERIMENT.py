...
# Exemple d'ús
mode = int(input("Aquest és l'script per executar l'experiment.\nSi desitges crear un nou conjunt de grafs introdueïx 0, si vols utilitzar els grafs ja existents al directori docs prem qualsevol altre nombre.\n"))
...
if(mode == 0):
    ...
    executar_script('./resource/ExperimentoC/Generador_Graella.py')
...
compilar_i_executar_cpp('./resource/ExperimentoC/resource/Experiment_GraellesQuadrades.cpp')

esperar_tecla("Juntem tots els resultats creats dins del fitxer estadisticageneral\n")
executar_script("./resource/ExperimentoC/resource/Compactador_estadistiques.py")

esperar_tecla("Visualitzem els resultats de l'estadística general\n")
executar_script("./resource/ExperimentoC/resource/Grafic_est_general.py")
